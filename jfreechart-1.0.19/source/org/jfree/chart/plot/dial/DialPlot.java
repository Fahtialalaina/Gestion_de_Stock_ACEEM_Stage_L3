 ...
 * generated by the <code>DialDemo2.java</code> program included in the
...
public class DialPlot extends Plot implements DialLayerChangeListener {
    ...
    /**
     * Tests this <code>DialPlot</code> instance for equality with an arbitrary
     * object. The plot's dataset(s) is (are) not included in the test.
     *
