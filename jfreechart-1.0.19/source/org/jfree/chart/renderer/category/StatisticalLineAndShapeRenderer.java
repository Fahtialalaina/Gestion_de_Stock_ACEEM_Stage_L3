 ...
 * the <code>StatisticalLineChartDemo1.java</code> program included in the
...
public class StatisticalLineAndShapeRenderer extends LineAndShapeRenderer
    ...
    /**
     * Sets the paint used for the error indicators (if <code>null</code>, the
     * item paint is used instead) and sends a {@link RendererChangeEvent} to
    ...
    /**
     * Sets the stroke used for the error indicators (if <code>null</code>, the
     * item outline stroke is used instead) and sends a
