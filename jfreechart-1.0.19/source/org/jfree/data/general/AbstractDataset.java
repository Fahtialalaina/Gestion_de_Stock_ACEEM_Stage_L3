...
public abstract class AbstractDataset implements Dataset, Cloneable,
     ...
     * {@link #fireDatasetChanged()} method will NOT trigger a dataset change
     * event.
     *
     * @return A boolean.
     *
     ...
     * flag to <code>true</code> will trigger a <code>DatasetChangeEvent</code>
     * because there may be queued up changes.
     *
     ...
     * that the <code>notify</code> flag has not been set to <code>false</code>.
     *
     * @see #addChangeListener(DatasetChangeListener)
     */
