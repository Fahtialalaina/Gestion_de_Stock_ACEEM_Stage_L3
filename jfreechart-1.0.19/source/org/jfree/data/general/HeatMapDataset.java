 ...
 * take any value (including <code>null</code> for unknown values).
 *
 * @since 1.0.13
 */
public interface HeatMapDataset {
     ...
     * method can return <code>null</code> to indicate a missing/unknown value.
     * <br><br>
     ...
     * require a new <code>Number</code> object to be allocated... for this
     * reason, it is generally preferable to use the
