...
public class StatisticalBarRendererTest {
     ...
     * exceptions are thrown (particularly by code in the renderer).
     */
    @Test
    ...
    /**
     * Draws the chart with a <code>null</code> mean value to make sure that no
     * exceptions are thrown (particularly by code in the renderer). See bug
     * report 1779941.
     */
    @Test
     ...
     * that no exceptions are thrown (particularly by code in the renderer). See
     * bug report 1779941.
     */
    @Test
