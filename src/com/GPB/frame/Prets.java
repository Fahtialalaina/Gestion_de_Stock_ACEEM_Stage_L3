...
//                txtper.setText(t2);
    ...
    private void initComponents() {
        ...
        jScrollPane4.setBounds(0, 460, 1040, 200);
        ...
        suppPret.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        modifierPret.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        formationbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel8.setBounds(780, 330, 90, 16);

        date1.setDateFormatString("yyyy-MM-dd");
        getContentPane().add(date1);
        date1.setBounds(780, 350, 120, 29);

        date2.setDateFormatString("yyyy-MM-dd");
        getContentPane().add(date2);
        date2.setBounds(930, 350, 110, 29);
        ...
        Rech2date.setBounds(780, 380, 260, 32);
        ...
        TotalAPayer.setBounds(270, 340, 160, 16);
        ...
        Effectif1.setBounds(80, 340, 34, 16);
